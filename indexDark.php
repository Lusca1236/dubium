            ...
            <div class="top-bar">
                <div class="buttons-bar">
                    <div class="left-buttons not-selectable">
                        ...
                        <a href="indexLigth.php" style="text-decoration: none;"><i class="material-symbols-outlined btn-sm light-dark-btn light-mode">light_mode</i></a>
                    </div>
